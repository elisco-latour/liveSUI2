...
;(function($, window, document, undefined){
    ...
    defaults = {
       ...
       speed: 1,  //动画Render distance离.
       timing: 1, //动画Vitesse de rendu
       mouse: true //Déplacez la souris pour arrêter动画
    ...
    Widget.prototype = {
       ...
       /**
        ...
        timer : function(that){
            ...
            //Current style
            this.$element.children().eq(that.next + 1).toggleClass('current-course');
            this.$element.children().eq(that.next + 1 + this.$items.length).toggleClass('current-course');
            //Old style
            this.$element.children().eq(that.next).removeClass('current-course');
            this.$element.children().eq(that.next + this.$items.length).removeClass('current-course');
        },
